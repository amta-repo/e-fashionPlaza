        ...
        <div className="bg-muted py-8">
          <div className="container px-4">
            ...
            <p className="text-muted-foreground">
              Notre collection de vêtements de marque arrive bientôt
            </p>
          </div>
        </div>
        ...
        <div className="container px-4 py-16">
          <Card className="max-w-lg mx-auto text-center p-12">
            <CardContent className="space-y-6">
              ...
              <p className="text-muted-foreground">
                Nous préparons une sélection exclusive de vêtements pour homme et femme. 
                T-shirts, chemises, pantalons et plus encore — restez connectés !
              </p>
