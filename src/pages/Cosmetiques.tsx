        ...
        <div className="bg-muted py-8">
          <div className="container px-4">
            ...
            <p className="text-muted-foreground">
              Produits de beauté et cosmétiques de qualité
            </p>
          </div>
        </div>
        ...
        <div className="container px-4 py-16">
          <Card className="max-w-lg mx-auto text-center p-12">
            <CardContent className="space-y-6">
              ...
              <p className="text-muted-foreground">
                Notre sélection de cosmétiques et produits de beauté sera disponible très prochainement.
                Crèmes, parfums, maquillage et soins — pour sublimer votre beauté !
              </p>
